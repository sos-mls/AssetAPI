<?php
/**
 * Contains the ApiController, a controller representing basic RestAPI controller.
 * 
 ...
 * ApiController class.
 *
 * A simple parent class to give basic Restful API functionality inside of PHP.
 * 
...
class ApiController extends CController {
     ...
     *
     * Goes through the status codes to get a message equivalent to the
     * 
     * @param mixed $status 
     * @access private
     * @return string
