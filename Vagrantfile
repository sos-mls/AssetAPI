Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder "src/", "/var/www/asset_api/src", owner: "www-data", group: "www-data"
  config.vm.synced_folder "build/", "/var/www/asset_api/build", owner: "vagrant", group: "vagrant"
